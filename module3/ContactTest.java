...
public class ContactTest {
 ...
 private Contact contact; 
  ...
  @Test
  void contactsWithSameName_keepPhoneDetailsIndependent() {
    Contact firstContact = new Contact("Grace Hopper", "+1 617 555 0102");
    Contact secondContact = new Contact("Grace Hopper", "+1 617 555 0103");

    assertNotSame(firstContact, secondContact);
    assertEquals("+1 617 555 0102", firstContact.getPhone());
    assertEquals("+1 617 555 0103", secondContact.getPhone());
  }
} 